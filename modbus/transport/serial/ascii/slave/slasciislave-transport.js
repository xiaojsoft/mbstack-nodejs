...
/**
 *  Modbus ASCII slave transaction.
 * 
 *  @constructor
 ...
 *    - The ignore callback.
 */
function MBAsciiSlaveTransaction(
    query, 
    queryStateBits,
    cbResponseAnswer, 
    cbResponseIgnore
...
/**
 *  Modbus ASCII slave transport options.
 * 
 *  @constructor
 */
function MBAsciiSlaveTransportOption() {
    //  Nothing.
}
 ...
 *    - The transceiver.
 *  @param {MBAsciiSlaveTransportOption} [options]
 *    - The transport options.
 */
function MBAsciiSlaveTransport(
    rxtx,
    options = new MBAsciiSlaveTransportOption()
) {
    //  Let parent class initialize.
    ...
    (async function() {
        ...
        while(true) {
            ...
            let transaction = new MBAsciiSlaveTransaction(
            ...
            let frameAnswer = new MBAsciiFrame(
                queryAddress, 
 ...
 */
function MBAsciiSlaveTransportFactory() {
    //  Let parent class initialize.
    ...
    this.create = async function(
        ...
        return new MBAsciiSlaveTransport(
            new MBAsciiTransceiver(port),
            new MBAsciiSlaveTransportOption()
        );
    };
}
...
//  Inheritances.
//
Util.inherits(MBAsciiSlaveTransaction, IMBSlaveTransaction);
Util.inherits(MBAsciiSlaveTransport, IMBSlaveTransport);
Util.inherits(MBAsciiSlaveTransportFactory, IMBSlaveTransportFactory);

//  Export public APIs.
module.exports = {
    "MBAsciiSlaveTransport": MBAsciiSlaveTransport,
    "MBAsciiSlaveTransportFactory": MBAsciiSlaveTransportFactory
};