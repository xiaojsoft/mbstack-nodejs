...
/**
 *  Modbus master protocol-layer read input registers (0x04) parser.
 * 
 *  Note(s):
 *    [1] The data type of the parse output is Number[], the data is an Array 
 *        that contains the value of input registers.
 * 
 *  @constructor
 *  @param {Number} nExpectedRegs 
 *    - The expected count of input registers.
 */
function MBMasterProtocolReadInputRegistersParser(nExpectedRegs) {
...
//
Util.inherits(
    MBMasterProtocolReadInputRegistersParser, 
